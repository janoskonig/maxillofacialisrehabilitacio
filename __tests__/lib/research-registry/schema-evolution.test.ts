...
} from '@/lib/research-registry/schema-evolution';
import { CURRENT_EXPORT_SCHEMA_VERSION } from '@/lib/research-registry/export-service';
...
describe('schema-evolution', () => {
  ...
  it('lists registry migration compatibility cases', () => {
