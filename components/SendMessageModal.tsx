...
export function SendMessageModal({ isOpen, onClose }: SendMessageModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-gray-900 rounded-xl max-w-2xl w-full max-h-[90vh] flex flex-col shadow-soft-xl animate-slide-up"
        ...
        <div className="sticky top-0 bg-white dark:bg-gray-900 border-b px-6 py-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Üzenetek</h2>
              {unreadCount > 0 && (
          ...
          <div className="flex gap-2 border-b">
            <button
              ...
              className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${
                activeTab === 'send'
                  ? 'text-blue-600 dark:text-blue-300 border-blue-600'
          ...
          {activeTab === 'send' ? (
            <>
              {!selectedPatient ? (
                <div className="p-6 space-y-4 overflow-y-auto">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      {loading ? (
                        <div className="text-center py-4 text-gray-500 dark:text-gray-400">Betöltés...</div>
                      ) : (
                          ...
                          {filteredPatients.length === 0 ? (
                            ...
                            filteredPatients.map((patient) => (
                              <button
                                ...
                                className="w-full px-4 py-3 text-left hover:bg-gray-50 dark:hover:bg-gray-800/50 border-b last:border-b-0 transition-colors"
                              >
                ...
                <>
                  {/* Chat Header */}
                  <div className="border-b px-6 py-3 bg-gray-50 dark:bg-gray-800/60 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <button
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          ...
                          {message.patientTaj && (
                            <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">TAJ: {message.patientTaj}</div>
                          )}
                          {message.subject && (
                            <div className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{message.subject}</div>
                          )}
