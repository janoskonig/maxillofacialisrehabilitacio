...
export const GEO: Record<ToothGroup, ToothGeometry> = {
  incisor: {
...
/**
 * Egyetlen fog belső rajza — SVG gyerekelemek, KÜLSŐ <svg> nélkül.
 * A koordináta-rendszer a 0..28 (x) × 0..40 (y) dobozra van értelmezve.
 * Így önállóan (Tooth) és egy közös ív-SVG-be komponálva is használható.
 */
