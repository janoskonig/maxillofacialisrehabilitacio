...
export function DocumentRequestCard({
  ...
  if (!document) {
    return (
      <div className="bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-800 rounded-lg p-4 my-2">
        <div className="flex items-center gap-3">
          <FileText className="w-5 h-5 text-gray-400 dark:text-gray-500" />
          <span className="text-sm text-gray-600 dark:text-gray-400">Dokumentum nem található</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-blue-50 dark:bg-blue-950/40 border-2 border-blue-200 dark:border-blue-800 rounded-lg p-4 my-2 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors">
      <div className="flex items-start gap-3">
        <div className="p-2 bg-blue-200 dark:bg-blue-900/50 rounded-lg text-blue-700 dark:text-blue-300 flex-shrink-0">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2 mb-1">
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-blue-600 dark:text-blue-300 truncate" title={document.filename}>
                {document.filename}
              </div>
              {document.description && (
                <div className="text-xs text-blue-600 dark:text-blue-300 mt-1 line-clamp-2">
                  {document.description}
                </div>
              )}
              <div className="flex items-center gap-2 mt-2 text-xs text-blue-600 dark:text-blue-300">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 mt-2 text-xs font-medium text-blue-700 dark:text-blue-300 hover:text-blue-900 transition-colors"
          >
