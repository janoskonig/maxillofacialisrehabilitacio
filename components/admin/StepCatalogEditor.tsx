    ...
    <div className="space-y-4">
      ...
      <div className="border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden">
        <button
          ...
          className="w-full flex items-center justify-between px-4 py-2 bg-gray-50 dark:bg-gray-800/60 hover:bg-gray-100 dark:hover:bg-gray-700 text-left text-sm font-medium"
        >
        ...
        {batchExpanded && (
          <div className="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-800 space-y-3">
            <p className="text-xs text-gray-600 dark:text-gray-400">
              CSV formátum: <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">step_code,label_hu,label_en,is_active</code> (oszlopnév <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">step_code</code> = work_phase_code) — fejléc opcionális. Elválasztó: vessző vagy pontosvessző.
            </p>
            <div className="flex gap-2 flex-wrap items-center">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 rounded text-sm flex items-center gap-1"
              >
                Fájl kiválasztása
              </button>
              <a
            ...
            <textarea
              ...
              rows={6}
              className="w-full font-mono text-sm border border-gray-300 dark:border-gray-700 rounded p-2"
            />
            <div className="flex items-center gap-3">
              ...
              {batchMessage && (
                <span
                  className={`text-sm ${batchStatus === 'success' ? 'text-green-700 dark:text-green-300' : batchStatus === 'error' ? 'text-red-600 dark:text-red-300' : 'text-gray-600 dark:text-gray-400'}`}
                >
                  {batchMessage}
                </span>
              )}
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
          <thead className="bg-gray-50 dark:bg-gray-800/60">
            <tr>
              <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">kód</th>
              <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">label_hu</th>
              <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">label_en</th>
                  ...
                  <td className="px-4 py-2">
                    {edit ? (
                      <div className="flex gap-2 items-center flex-wrap">
                        ...
                        {status === 'error' && errMsg && (
                          <span className="text-red-600 dark:text-red-300 text-xs">{errMsg}</span>
                        )}
                      </div>
                    ) : (
                      <button
