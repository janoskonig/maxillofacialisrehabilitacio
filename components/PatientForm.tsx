...
export function PatientForm({
  ...
  const getUnsavedChangesList = useCallback((): string[] => {
    ...
    const fieldNames: Record<string, string> = {
      ...
      maxillaDefektusRaszter: 'Maxilladefektus kiterjedése (raszter)',
      mandibulaDefektusRaszter: 'Mandibuladefektus kiterjedése (raszter)',
    ...
    if (!isNewPatient && referencePatient) {
      ...
      const keyFields: (keyof Patient)[] = [
        ...
        'maxillaDefektusRaszter', 'mandibulaDefektusRaszter',
  ...
  const fieldToSectionMap: Record<string, string> = {
    ...
    maxillaDefektusRaszter: 'anamnezis',
    mandibulaDefektusRaszter: 'anamnezis',
