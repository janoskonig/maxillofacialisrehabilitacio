...
/**
 * GET /api/scheduling/integrity
 * Daily integrity report: episodes with >1 future work appt, open intents on closed episodes,
 * appointments without slots, slots with multiple appointments.
 */
