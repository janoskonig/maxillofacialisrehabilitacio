      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-8">
          ...
          <div className="mb-6 flex items-center justify-between">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Adatvédelmi Irányelvek</h1>
            <Link 
              href="/privacy" 
          ...
          <div className="prose prose-sm max-w-none text-gray-700 dark:text-gray-300 space-y-6">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">1. Adatkezelő</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">2. Gyűjtött Információk</h2>
              
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mt-4 mb-2">2.1 Betegadatok</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mt-4 mb-2">2.2 Egészségügyi dolgozók fiókadatai</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mt-4 mb-2">2.3 Google Calendar integráció</h3>
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mt-4 mb-2">2.4 Hozzájárulási nyilvántartás</h3>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">3. Az Adatkezelés Jogalapjai</h2>
                ...
                <table className="min-w-full text-sm border border-gray-200 dark:border-gray-800">
                  <thead>
                    <tr className="bg-gray-50 dark:bg-gray-800/60">
                      <th className="border border-gray-200 dark:border-gray-800 px-3 py-2 text-left font-semibold">Adatkezelési tevékenység</th>
                      <th className="border border-gray-200 dark:border-gray-800 px-3 py-2 text-left font-semibold">Jogalap</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Beteg egészségügyi adatok kezelése</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">9. cikk (2)(h) &ndash; Egészségügyi ellátás + kifejezett hozzájárulás</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Személyzeti fiók kezelés</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">6. cikk (1)(b) &ndash; Szerződés teljesítése</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Google Calendar szinkronizáció</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">6. cikk (1)(a) &ndash; Hozzájárulás</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Hibakövetés (Sentry, ha engedélyezve)</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">6. cikk (1)(a) &ndash; Hozzájárulás</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Email értesítések</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">6. cikk (1)(b) &ndash; A szolgáltatás nyújtásához szükséges</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Biztonsági naplózás és audit</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">6. cikk (1)(f) &ndash; Jogos érdek (rendszerbiztonság)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">4. Az Információk Használata</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">5. Adatbiztonság</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">6. Adatok Megosztása és Közlése</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">7. Adatok Megőrzése</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">8. Az Ön GDPR Szerinti Jogai</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">9. Harmadik Fél Szolgáltatások és Adatfeldolgozók</h2>
              ...
              <div className="overflow-x-auto mt-3">
                <table className="min-w-full text-sm border border-gray-200 dark:border-gray-800">
                  <thead>
                    <tr className="bg-gray-50 dark:bg-gray-800/60">
                      <th className="border border-gray-200 dark:border-gray-800 px-3 py-2 text-left font-semibold">Szolgáltatás</th>
                      <th className="border border-gray-200 dark:border-gray-800 px-3 py-2 text-left font-semibold">Cél</th>
                      <th className="border border-gray-200 dark:border-gray-800 px-3 py-2 text-left font-semibold">Adattárolás helye</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Google Calendar API</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Időpont szinkronizáció (opcionális, hozzájárulás alapú)</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">EU/US (Google SCC-k)</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Sentry</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Hibamonitorozás (opcionális, hozzájárulás alapú, PII törlésével)</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">US (Sentry DPA + SCC-k)</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">SMTP Email szolgáltató</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Tranzakciós emailek (időpont, megerősítés)</td>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Betűkészlet szolgáltatás (Inter betűtípus)</td>
                      <td className="border border-gray-200 dark:border-gray-800 px-3 py-2">Globális CDN</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">10. Sütik és Helyi Tárolás</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">11. Gyermekek Adatvédelme</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">12. Adatvédelmi Incidens Értesítés</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">13. Az Adatvédelmi Irányelv Módosításai</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">14. Kapcsolatfelvétel</h2>
              <p>
