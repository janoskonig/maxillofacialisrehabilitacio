...
export const PATIENT_SELECT_FIELDS = `
  ...
  varos,
  iranyitoszam,
  torvenyes_kepviselo_nev as "torvenyesKepviseloNev",
  torvenyes_kepviselo_kapcsolat as "torvenyesKepviseloKapcsolat",
  torvenyes_kepviselo_email as "torvenyesKepviseloEmail",
