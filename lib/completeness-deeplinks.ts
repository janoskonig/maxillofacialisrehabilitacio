...
export const FIELD_TARGET: Record<string, { tab: string; anchor: string }> = {
  ...
  beutaloIndokolas: { tab: 'torzsadatok', anchor: 'section-beutalo' },
  mutetLeiras: { tab: 'anamnezis', anchor: 'section-anamnezis' },
  mutetIdeje: { tab: 'anamnezis', anchor: 'section-anamnezis' },
  szovettan: { tab: 'anamnezis', anchor: 'section-anamnezis' },
  tnmStaging: { tab: 'anamnezis', anchor: 'section-anamnezis' },
  maxillaDefektusRaszter: { tab: 'anamnezis', anchor: 'section-betegvizsgalat' },
  mandibulaDefektusRaszter: { tab: 'anamnezis', anchor: 'section-betegvizsgalat' },
